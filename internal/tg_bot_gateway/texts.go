...
func welcomeText() string {
	return "👋 *Добро пожаловать в House VPN!*\n" +
		...
		"• высокая скорость;\n" +
		"• все необходимые и лучшие локации.\n" +
		"\n" +
...
func downloadVPNText() string {
	return "📥 *Скачать приложение*\n\n" +
		...
		"⭐ *Настоятельно рекомендуем Happ или Incy* — с ними всё настраивается автоматически: при заходе на любые сайты ничего выключать не нужно. Работает максимально стабильно.\n\n" +
